...
####################################################################;
  ...
  legend(0,1,bty="n", cex=0.8, title="Age Group",c("0-1","1-2","2-5"),fill=c("antiquewhite2","antiquewhite3","antiquewhite4"))
}
...
#####################################################################;
  ...
  for(k.neighb in 1:n.neighb){
    z.exp <- mergequan(cbind(log10(non0(int.dirt1[k.neighb,])),log10(non0(int.dirt2[k.neighb,])),log10(non0(int.dirt3[k.neighb,])), # dirt floor -> hand-mouth
                             ...
                             log10(non0(int.total1[k.neighb,])),log10(non0(int.total2[k.neighb,])),log10(non0(int.total3[k.neighb,]))), 
    ...
    bxp(z.exp,outline=FALSE,ylim=c(0,20),las = 2,
        ...
        ylab="10log(dose)",main=paste(neighbourhoods[k.neighb]),cex.axis = 0.8);
...
for(k.age in 1:3){
  ...
  legend(0,1,bty="n", cex=0.8, title="Neighborhood",neighbourhoods,fill=c("antiquewhite1","antiquewhite2","antiquewhite3","antiquewhite4"))
  ...
  bxp(z.exp,outline=FALSE,ylim=c(0,20),las = 2,
      boxfill=c("antiquewhite1","antiquewhite2","antiquewhite3","antiquewhite4","antiquewhite1","antiquewhite2","antiquewhite3","antiquewhite4","antiquewhite1","antiquewhite2","antiquewhite3","antiquewhite4",
                "antiquewhite1","antiquewhite2","antiquewhite3","antiquewhite4","antiquewhite1","antiquewhite2","antiquewhite3","antiquewhite4","antiquewhite1","antiquewhite2","antiquewhite3","antiquewhite4",
                "antiquewhite1","antiquewhite2","antiquewhite3","antiquewhite4","antiquewhite1","antiquewhite2","antiquewhite3","antiquewhite4","antiquewhite1","antiquewhite2","antiquewhite3","antiquewhite4"),
      ylab="10log(dose)",main=paste("Age Group",ages[k.age]),cex.axis = 0.8);
...
plot(SP3D.dat1$env.intake[which(SP3D.dat1$Neighb==1)],SP3D.dat1$frac0[which(SP3D.dat1$Neighb==1)],type="p",col=SP3D.dat1$pcolor,pch=15,cex=1,xlim=c(0,20),ylim=c(0,1),
     main="Age 0-1", ylab="Probability of No intake", xlab="Log 10 Mean E. coli Intake For 14 Hours (CFU)")
points(SP3D.dat1$env.intake[which(SP3D.dat1$Neighb==2)],SP3D.dat1$frac0[which(SP3D.dat1$Neighb==2)],type="p",col=SP3D.dat1$pcolor,pch=17,cex=1)
points(SP3D.dat1$env.intake[which(SP3D.dat1$Neighb==3)],SP3D.dat1$frac0[which(SP3D.dat1$Neighb==3)],type="p",col=SP3D.dat1$pcolor,pch=18,cex=1)
points(SP3D.dat1$env.intake[which(SP3D.dat1$Neighb==4)],SP3D.dat1$frac0[which(SP3D.dat1$Neighb==4)],type="p",col=SP3D.dat1$pcolor,pch=19,cex=1)
...
#scatter plot - X:intake Y:Fract0
plot(SP3D.dat2$env.intake[which(SP3D.dat2$Neighb==1)],SP3D.dat2$frac0[which(SP3D.dat2$Neighb==1)],type="p",col=SP3D.dat2$pcolor,pch=15,cex=1,xlim=c(0,20),ylim=c(0,1),
     main="Age 1-2", ylab="Probability of No intake", xlab="Log 10 Mean E. coli Intake For 14 Hours (CFU)")
points(SP3D.dat2$env.intake[which(SP3D.dat2$Neighb==2)],SP3D.dat2$frac0[which(SP3D.dat2$Neighb==2)],type="p",col=SP3D.dat2$pcolor,pch=17,cex=1)
points(SP3D.dat2$env.intake[which(SP3D.dat2$Neighb==3)],SP3D.dat2$frac0[which(SP3D.dat2$Neighb==3)],type="p",col=SP3D.dat2$pcolor,pch=18,cex=1)
points(SP3D.dat2$env.intake[which(SP3D.dat2$Neighb==4)],SP3D.dat2$frac0[which(SP3D.dat2$Neighb==4)],type="p",col=SP3D.dat2$pcolor,pch=19,cex=1)
...
#scatter plot - X:intake Y:Fract0
plot(SP3D.dat3$env.intake[which(SP3D.dat3$Neighb==1)],SP3D.dat3$frac0[which(SP3D.dat3$Neighb==1)],type="p",col=SP3D.dat3$pcolor,pch=15,cex=1,xlim=c(0,20),ylim=c(0,1),
     main="Age 2-5", ylab="Probability of No intake", xlab="Log 10 Mean E. coli Intake For 14 Hours (CFU)")
points(SP3D.dat3$env.intake[which(SP3D.dat3$Neighb==2)],SP3D.dat3$frac0[which(SP3D.dat3$Neighb==2)],type="p",col=SP3D.dat3$pcolor,pch=17,cex=1)
points(SP3D.dat3$env.intake[which(SP3D.dat3$Neighb==3)],SP3D.dat3$frac0[which(SP3D.dat3$Neighb==3)],type="p",col=SP3D.dat3$pcolor,pch=18,cex=1)
points(SP3D.dat3$env.intake[which(SP3D.dat3$Neighb==4)],SP3D.dat3$frac0[which(SP3D.dat3$Neighb==4)],type="p",col=SP3D.dat3$pcolor,pch=19,cex=1)
...
pdf(paste("./output/","exposure","-network",".pdf",sep=""));
...
eqarrowPlot(edge.network, layout.auto(edge.network), edge.arrow.size=weight/10,
            edge.width=1, vertex.size=25)
