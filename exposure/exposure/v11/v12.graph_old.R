...
##############################################################################;
setEPS();
postscript(paste("./output/","exposure","-hh",".eps",sep=""));
for (k.age in 1:3){
  if (k.age==1){
    int.dirt<-HH.1[[14]]
    int.flo<-HH.1[[16]]
...
setEPS();
postscript(paste("./output/","exposure","-hh-by-age",".eps",sep=""));
for (k.age in 1:3){
  if (k.age==1){
    int.dirt1<-HH.1[[14]]
    int.flo1<-HH.1[[16]]
...
setEPS();
postscript(paste("./output/","exposure","-hh-by-neighb",".eps",sep=""));
for (k.age in 1:3){
  if (k.age==1){
    int.dirt1<-HH.1[[14]]
    int.flo1<-HH.1[[16]]
...
setEPS();
postscript(paste("./output/","exposure","-network-color1",".eps",sep=""));
...
setEPS();
postscript(paste("./output/","exposure","-network-color2",".eps",sep=""),width=10.00, height=14.14);
