...
setwd("~/stat/sanipath/exposure/exposure/v11/")
pdf(paste("./output1/","exposure","-2D-scatterplot",".pdf",sep=""));
...
pdf(paste("./output1/","exposure","-network-color1",".pdf",sep=""));
...
pdf(paste("./output1/","exposure","-network-color2",".pdf",sep=""),width=10.00, height=14.14);
