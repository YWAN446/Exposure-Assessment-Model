...
n.neighb <- 4;
num.mc <- 1000;
setwd("~/stat/sanipath/exposure/exposure/v10/")
##############################################################################;
...
for (k.age in 1:3){
  ...
  for(k.neighb in 1:n.neighb){
    ...
    bxp(z.exp,outline=FALSE,ylim=c(0,20),las=2,
        ylab="10log(dose)",main=paste(neighbourhoods[k.neighb],ifelse(k.age==1,"0-1",ifelse(k.age==2,"1-2","2-5"))),cex.axis = 0.8);
...
layout(matrix(c(1,2), 2, 1, byrow = TRUE), heights=c(1,3))
  for(k.neighb in 1:n.neighb){
    ...
    barplot(c(frac0(int.dirt1[k.neighb,]),frac0(int.dirt2[k.neighb,]),frac0(int.dirt3[k.neighb,]),
              frac0(int.flo1[k.neighb,]),frac0(int.flo2[k.neighb,]),frac0(int.flo3[k.neighb,]),
              frac0(int.offgr1[k.neighb,]),frac0(int.offgr2[k.neighb,]),frac0(int.offgr3[k.neighb,]),
              frac0(int.drain1[k.neighb,]),frac0(int.drain2[k.neighb,]),frac0(int.drain3[k.neighb,]),
              frac0(int.septage1[k.neighb,]),frac0(int.septage2[k.neighb,]),frac0(int.septage3[k.neighb,]),
              frac0(int.produce1[k.neighb,]),frac0(int.produce2[k.neighb,]),frac0(int.produce3[k.neighb,]),
              frac0(dw1[k.neighb,1,]),frac0(dw2[k.neighb,1,]),frac0(dw2[k.neighb,1,]),
              frac0(dw2[k.neighb,2,]),frac0(dw2[k.neighb,2,]),frac0(dw2[k.neighb,2,]),
              frac0(int.total1[k.neighb,]),frac0(int.total2[k.neighb,]),frac0(int.total3[k.neighb,])),
            ylab="fraction 0",
...
for(k.age in 1:3){
  if (k.age==1){
  par(mar=c(0.5, 4, 2, 0.5))
  barplot(c(frac0(int.dirt1[1,]),frac0(int.dirt1[2,]),frac0(int.dirt1[3,]),frac0(int.dirt1[4,]),
            frac0(int.flo1[1,]),frac0(int.flo1[2,]),frac0(int.flo1[3,]),frac0(int.flo1[4,]),
            frac0(int.offgr1[1,]),frac0(int.offgr1[2,]),frac0(int.offgr1[3,]),frac0(int.offgr1[4,]),
            frac0(int.drain1[1,]),frac0(int.drain1[2,]),frac0(int.drain1[3,]),frac0(int.drain1[4,]),
            frac0(int.septage1[1,]),frac0(int.septage1[2,]),frac0(int.septage1[3,]),frac0(int.septage1[4,]),
            frac0(int.produce1[1,]),frac0(int.produce1[2,]),frac0(int.produce1[3,]),frac0(int.produce1[4,]),
            frac0(dw1[1,1,]),frac0(dw1[2,1,]),frac0(dw1[3,1,]),frac0(dw1[4,1,]),
            frac0(dw1[1,2,]),frac0(dw1[2,2,]),frac0(dw1[3,2,]),frac0(dw1[4,2,]),
            frac0(int.total1[1,]),frac0(int.total1[2,]),frac0(int.total1[3,]),frac0(int.total1[4,])),
          ylab="fraction 0",xaxt="n",
  ...
  bxp(z.exp,outline=FALSE,ylim=c(0,20),las = 2,
      boxfill=c("antiquewhite1","antiquewhite2","antiquewhite3","antiquewhite4","antiquewhite1","antiquewhite2","antiquewhite3","antiquewhite4","antiquewhite1","antiquewhite2","antiquewhite3","antiquewhite4",
                "antiquewhite1","antiquewhite2","antiquewhite3","antiquewhite4","antiquewhite1","antiquewhite2","antiquewhite3","antiquewhite4","antiquewhite1","antiquewhite2","antiquewhite3","antiquewhite4",
                "antiquewhite1","antiquewhite2","antiquewhite3","antiquewhite4","antiquewhite1","antiquewhite2","antiquewhite3","antiquewhite4","antiquewhite1","antiquewhite2","antiquewhite3","antiquewhite4"),
      ylab="10log(dose)",#main=paste("Age Group",ages[k.age]),
      cex.axis = 0.8,xaxt="n");
  ...
  axis(1, at=c(2.5,6.5,10.5,14.5,18.5,22.5,26.5,30.5,34.5), labels=c("dirt","floor","offgr","drain",
                                                  "septage","food","tap water","sachet","total"), las=1, cex.axis=0.8)
  
  }  
  if (k.age==2){
    par(mar=c(0.5, 4, 2, 0.5))
    barplot(c(frac0(int.dirt2[1,]),frac0(int.dirt2[2,]),frac0(int.dirt2[3,]),frac0(int.dirt2[4,]),
              frac0(int.flo2[1,]),frac0(int.flo2[2,]),frac0(int.flo2[3,]),frac0(int.flo2[4,]),
              frac0(int.offgr2[1,]),frac0(int.offgr2[2,]),frac0(int.offgr2[3,]),frac0(int.offgr2[4,]),
              frac0(int.drain2[1,]),frac0(int.drain2[2,]),frac0(int.drain2[3,]),frac0(int.drain2[4,]),
              frac0(int.septage2[1,]),frac0(int.septage2[2,]),frac0(int.septage2[3,]),frac0(int.septage2[4,]),
              frac0(int.produce2[1,]),frac0(int.produce2[2,]),frac0(int.produce2[3,]),frac0(int.produce2[4,]),
              frac0(dw2[1,1,]),frac0(dw2[2,1,]),frac0(dw2[3,1,]),frac0(dw2[4,1,]),
              frac0(dw2[1,2,]),frac0(dw2[2,2,]),frac0(dw2[3,2,]),frac0(dw2[4,2,]),
              frac0(int.total2[1,]),frac0(int.total2[2,]),frac0(int.total2[3,]),frac0(int.total2[4,])),
            ylab="fraction 0",xaxt="n",
            main=paste("Age Group",ages[k.age]),las = 2,
            #names=c("","dirt","","","","floor","","","","offgr","","","","drain","","","","septage","","","","food","","","","tap water","","","","sachet water","",""),
            col=c("antiquewhite1","antiquewhite2","antiquewhite3","antiquewhite4","antiquewhite1","antiquewhite2","antiquewhite3","antiquewhite4","antiquewhite1","antiquewhite2","antiquewhite3","antiquewhite4",
  ...
  if (k.age==3){
    par(mar=c(0.5, 4, 2, 0.5))
    barplot(c(frac0(int.dirt3[1,]),frac0(int.dirt3[2,]),frac0(int.dirt3[3,]),frac0(int.dirt3[4,]),
              frac0(int.flo3[1,]),frac0(int.flo3[2,]),frac0(int.flo3[3,]),frac0(int.flo3[4,]),
              frac0(int.offgr3[1,]),frac0(int.offgr3[2,]),frac0(int.offgr3[3,]),frac0(int.offgr3[4,]),
              frac0(int.drain3[1,]),frac0(int.drain3[2,]),frac0(int.drain3[3,]),frac0(int.drain3[4,]),
              frac0(int.septage3[1,]),frac0(int.septage3[2,]),frac0(int.septage3[3,]),frac0(int.septage3[4,]),
              frac0(int.produce3[1,]),frac0(int.produce3[2,]),frac0(int.produce3[3,]),frac0(int.produce3[4,]),
              frac0(dw3[1,1,]),frac0(dw3[2,1,]),frac0(dw3[3,1,]),frac0(dw3[4,1,]),
              frac0(dw3[1,2,]),frac0(dw3[2,2,]),frac0(dw3[3,2,]),frac0(dw3[4,2,]),
              frac0(int.total3[1,]),frac0(int.total3[2,]),frac0(int.total3[3,]),frac0(int.total3[4,])),
            ylab="fraction 0",xaxt="n",
            main=paste("Age Group",ages[k.age]),las = 2,
            #names=c("","dirt","","","","floor","","","","offgr","","","","drain","","","","septage","","","","food","","","","tap water","","","","sachet water","",""),
            col=c("antiquewhite1","antiquewhite2","antiquewhite3","antiquewhite4","antiquewhite1","antiquewhite2","antiquewhite3","antiquewhite4","antiquewhite1","antiquewhite2","antiquewhite3","antiquewhite4",
...
par(mar=c(2, 4, 2, 1))
plot(SP3D.dat1$env.intake[which(SP3D.dat1$Neighb==1)],SP3D.dat1$frac0[which(SP3D.dat1$Neighb==1)],type="p",col=SP3D.dat1$pcolor,pch=15,cex=2,xlim=c(0,20),ylim=c(0,1),
     #main="Age 0-1", 
     ylab="Probability of No intake", xlab="",
     #xlab="Log 10 Mean E. coli Intake For 14 Hours (CFU)",
     xaxt="n")
points(SP3D.dat1$env.intake[which(SP3D.dat1$Neighb==2)],SP3D.dat1$frac0[which(SP3D.dat1$Neighb==2)],type="p",col=SP3D.dat1$pcolor,pch=17,cex=2)
points(SP3D.dat1$env.intake[which(SP3D.dat1$Neighb==3)],SP3D.dat1$frac0[which(SP3D.dat1$Neighb==3)],type="p",col=SP3D.dat1$pcolor,pch=18,cex=2)
points(SP3D.dat1$env.intake[which(SP3D.dat1$Neighb==4)],SP3D.dat1$frac0[which(SP3D.dat1$Neighb==4)],type="p",col=SP3D.dat1$pcolor,pch=19,cex=2)
...
#scatter plot - X:intake Y:Fract0
par(mar=c(3, 4, 1, 1))
plot(SP3D.dat2$env.intake[which(SP3D.dat2$Neighb==1)],SP3D.dat2$frac0[which(SP3D.dat2$Neighb==1)],type="p",col=SP3D.dat2$pcolor,pch=15,cex=2,xlim=c(0,20),ylim=c(0,1),
     #main="Age 1-2",
     ylab="Probability of No intake", xlab="",
     #xlab="Log 10 Mean E. coli Intake For 14 Hours (CFU)",
     xaxt="n")
points(SP3D.dat2$env.intake[which(SP3D.dat2$Neighb==2)],SP3D.dat2$frac0[which(SP3D.dat2$Neighb==2)],type="p",col=SP3D.dat2$pcolor,pch=17,cex=2)
points(SP3D.dat2$env.intake[which(SP3D.dat2$Neighb==3)],SP3D.dat2$frac0[which(SP3D.dat2$Neighb==3)],type="p",col=SP3D.dat2$pcolor,pch=18,cex=2)
points(SP3D.dat2$env.intake[which(SP3D.dat2$Neighb==4)],SP3D.dat2$frac0[which(SP3D.dat2$Neighb==4)],type="p",col=SP3D.dat2$pcolor,pch=19,cex=2)
grid(nx=NULL, ny=NULL);
...
#scatter plot - X:intake Y:Fract0
par(mar=c(4, 4, 0, 1))
plot(SP3D.dat3$env.intake[which(SP3D.dat3$Neighb==1)],SP3D.dat3$frac0[which(SP3D.dat3$Neighb==1)],type="p",col=SP3D.dat3$pcolor,pch=15,cex=2,xlim=c(0,20),ylim=c(0,1),
     #main="Age 2-5", 
     ylab="Probability of No intake", xlab="Log 10 Mean E. coli Intake For 14 Hours (CFU)")
points(SP3D.dat3$env.intake[which(SP3D.dat3$Neighb==2)],SP3D.dat3$frac0[which(SP3D.dat3$Neighb==2)],type="p",col=SP3D.dat3$pcolor,pch=17,cex=2)
points(SP3D.dat3$env.intake[which(SP3D.dat3$Neighb==3)],SP3D.dat3$frac0[which(SP3D.dat3$Neighb==3)],type="p",col=SP3D.dat3$pcolor,pch=18,cex=2)
points(SP3D.dat3$env.intake[which(SP3D.dat3$Neighb==4)],SP3D.dat3$frac0[which(SP3D.dat3$Neighb==4)],type="p",col=SP3D.dat3$pcolor,pch=19,cex=2)
grid(nx=NULL, ny=NULL);
...
V(edge.network)$color <- ifelse(V(edge.network)$name=="Mouth","Blue",
...
l=matrix(c(0,-2,-3,2,-2.5,-2,-2.5,2.5,0.5,2,4,3,
           0,2,0,-2,-1,-2,1,0.5,2,1.5,0,2),12,2);
if (k.neighb==4) l=matrix(c(0,-2,-3,2,-2.5,-2,-2.5,3,2.5,0.5,2,4,0,2,0,-2,-1,-2,1,2,0.5,2,1.5,0),12,2);

curved<-c(0,0.5,0,0,0.5,0,0,0,0,0,0,0,0);
if (k.neighb==4) curved<-c(0,0.5,0,0,0.5,0,0,0,0,0,0,0,0);

eqarrowPlot(edge.network, l, edge.arrow.size=weight/10,edge.width=1, vertex.size=25, 
            edge.curved=curved);
